...
export default function Footer() {
  ...
  const brandDesc = language === 'de'
    ? 'Italienischer Personal Trainer in Deutschland. Transformiere deinen Körper mit personalisierten Programmen.'
    : 'Personal Trainer italiano in Germania. Trasforma il tuo corpo con programmi personalizzati.';
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/60 mb-6">{brandDesc}</p>
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/angelo_fitnesscoach" target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center hover:bg-gradient-to-r hover:from-pink-500 hover:via-fuchsia-500 hover:to-violet-500 transition-all" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@angelo.fitnesscoach" target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center hover:bg-black transition-all" aria-label="TikTok">
              ...
              <a href="https://wa.me/4917693193043" target="_blank" rel="noopener noreferrer" className="w-14 h-14 bg-white/10 rounded-xl flex items-center justify-center hover:bg-green-500 transition-all" aria-label="WhatsApp">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-bold uppercase tracking-wider mb-6">{pagesTitle}</h4>
            <ul className="space-y-4">
              {pages.map((page) => (
                <li key={page.href + page.label}>
                  <Link href={page.href} className="text-white/60 hover:text-fuchsia-400 transition-colors">{page.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Services */}
          <div>
            <h4 className="text-sm font-bold uppercase tracking-wider mb-6">{servicesTitle}</h4>
            <ul className="space-y-4">
              {services.map((service, idx) => (
                <li key={idx}>
                  <Link href={service.href} className="text-white/60 hover:text-fuchsia-400 transition-colors">{service.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-sm font-bold uppercase tracking-wider mb-6">{contactTitle}</h4>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-4">
          <div className="flex flex-wrap justify-center gap-6 text-sm text-white/40">
            <Link href="/termini" className="hover:text-fuchsia-400 transition-colors">{termsLink}</Link>
            <Link href="/privacy" className="hover:text-fuchsia-400 transition-colors">{privacyLink}</Link>
            <Link href="/cookie" className="hover:text-fuchsia-400 transition-colors">{cookieLink}</Link>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-white/40">
            ...
            <p className="mt-2 md:mt-0">
              {madeBy}{" "}
              <a href="https://massaromarketer.com" target="_blank" rel="noopener noreferrer" className="text-fuchsia-400 hover:text-fuchsia-300 transition-colors">Massaromarketer.com</a>
            </p>
          </div>
        </div>
      </div>
